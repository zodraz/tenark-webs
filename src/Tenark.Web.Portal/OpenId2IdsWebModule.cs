...
using OpenId2Ids.Web.Portal.Menus;
...
public class OpenId2IdsWebModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.Conventions.AuthorizePage("/Books/Index", TenarkPermissions.Books.Default);
            options.Conventions.AuthorizePage("/Books/CreateModal", TenarkPermissions.Books.Create);
            options.Conventions.AuthorizePage("/Books/EditModal", TenarkPermissions.Books.Edit);
        });
    }
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<OpenId2IdsDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Tenark.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<OpenId2IdsApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Tenark.Application.Contracts"));
